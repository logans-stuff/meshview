...
class Packet(Base):
    ...
    channel: Mapped[str] = mapped_column(nullable=True)
    request_id: Mapped[int] = mapped_column(BigInteger, nullable=True)
    ...
    __table_args__ = (
        ...
        Index("idx_packet_request_id", "request_id"),
        Index("idx_packet_portnum_request_id", "portnum", "request_id"),
    )
